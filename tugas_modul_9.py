...
Original file is located at
    https://colab.research.google.com/drive/14XYZHhktvnyqm3AqYlq4vFNIToSArcih
"""
...
FileDB = '/content/drive/My Drive/Tugas Modul 9/cos.txt' # Sesuaikan path file
...
regregregreg = DecisionTreeRegressor(random_state=1)
reg = reg.fit(x, y)
